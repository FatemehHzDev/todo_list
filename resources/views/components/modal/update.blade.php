...
>
    ...
    <div
        ...
        class="mb-6  bg-white dark:bg-gray-800 rounded-lg overflow-hidden  transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto shadow-[0px_0px_20px_5px_rgba(0,0,0,0.6)]"
        x-transition:enter="ease-out duration-300"
    ...
    >
        ...
        <footer class="flex text-center">
            ...
            <button type="submit" wire:click="cancel_update()" class="py-2 bg-gray-300 w-1/4">
                {{__('لغو')}}
            </button>
        </footer>
    </div>
